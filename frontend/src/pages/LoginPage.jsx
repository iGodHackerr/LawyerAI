    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen bg-gray-900 text-white p-4">
            ...
            <div className="text-center">
                ...
                <h1 className="text-4xl sm:text-5xl font-bold text-white mb-3">{t('appTitle')}</h1>
                <p className="text-lg sm:text-xl text-gray-400 mb-8">{t('appSubtitle')}</p>
                <div className="flex justify-center">
                    ...
                    >
                        ...
                        <span>{isLoading ? t('connecting') : t('startSession')}</span>
                    </button>
                </div>
